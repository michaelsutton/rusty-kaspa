...
/// Ark-serialized compressed Groth16 VK for the fixed R0 circuit.
...
mod tests {
    ...
    #[test]
    fn compressed_vk_matches_uncompressed_vk() {
        use ark_bn254::Bn254;
        ...
        verifying_key.serialize_compressed(&mut compressed_vk).unwrap();
        assert_eq!(compressed_vk, super::R0_SERIALIZED_COMPRESSED_VK);
    }
